          ...
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <p className="text-lg text-zinc-500">appmint can understand what you are designing, learn from your feedback to take your creativity further, and turn it instantly into beautiful images.</p>
              </div>
              {/* Tabs buttons */}
